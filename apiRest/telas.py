...
def menu():
    ...
    if resposta == '1':
        ...
        if opcao == '1':
            ...
            import requests
            url = "http://172.16.103.6:5000/historico/"+ setor + '/' + id
            payload = ""
            response = requests.request("GET", url, data=payload) 
        ...
        if senha == '1234':
            ...
            if opcao == '1':
                ...
                url = "http://172.16.103.6:5000/teto/"  + teto
                payload = " "
                ...
                print('Abra o navegador em 172.16.103.6:5002/hidrometro/<string:setor>/<string:id>')
            else:
                menu()  
        else:
            print('Senha errada!')
